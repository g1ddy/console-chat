...
public class ChatConsoleTests
{
    ...
    {
        var (header, j, style) = ChatConsoleHelpers.GetUserStyle(ChatRole.User);
    ...
    {
        var (header, j, style) = ChatConsoleHelpers.GetUserStyle(ChatRole.Assistant);
    ...
    {
        var (header, j, style) = ChatConsoleHelpers.GetUserStyle(ChatRole.Tool);
